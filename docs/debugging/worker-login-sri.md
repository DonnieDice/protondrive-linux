...
**Status:** Fixed in v1.1.3 (2026-05-07). Clean rebuild removed SRI, corrected nested chunk paths, and validated Account/Drive loading.
...
### Session: 2026-05-07 v1.1.3 Fedora Login Validation
...
**Release Status:** Prepared for `v1.1.3`.
...
- GitHub #37: Challenge navigation blocked (superseded by v1.1.3 top-level captcha flow)
