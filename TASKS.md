...
This repo currently ships the Tauri/WebKitGTK Proton Drive desktop wrapper. The immediate release target is v1.1.5 with validated Fedora/RPM login, CAPTCHA, 2FA, app selection, and Drive launch.
