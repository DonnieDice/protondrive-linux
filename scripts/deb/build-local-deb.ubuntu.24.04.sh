...
echo "=========================================="
echo "Proton Drive DEB Build — Ubuntu 24.04"
echo "=========================================="
...
PATCH_FILE="patches/deb/ubuntu.24.04.patch"
...
target="proton-drive_${VERSION}_ubuntu24.04_amd64.deb"
...
echo ""
echo "=========================================="
echo "Ubuntu 24.04 DEB Build Complete!"
echo "=========================================="
ls -lh "$DEB_DIR"/*.deb
