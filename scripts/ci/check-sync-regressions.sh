...
require_pattern docs/sync.md "ProtonDriveLinuxSyncBridge" "WebClients sync bridge must stay documented"
...
require_pattern patches/common/show-drive-drawer-rail-in-desktop-shell.patch "showDrawerSidebar: true" "Linux desktop build must show the drawer rail by default"
require_pattern patches/common/show-drive-drawer-rail-in-desktop-shell.patch "Proton Drive Linux owns native sync/settings controls in this rail" "drawer visibility override must remain documented in source"
require_pattern docs/sync.md "shows that rail on startup" "Linux drawer startup behavior must stay documented"
